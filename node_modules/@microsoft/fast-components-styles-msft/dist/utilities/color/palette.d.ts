 ...
 *          )
 */
export declare function swatchByContrast(referenceColor: string | SwatchResolver): (paletteResolver: string[] | DesignSystemResolver<string[]>) => (indexResolver: (referenceColor: string, palette: string[], designSystem: DesignSystem) => number) => (directionResolver: (referenceIndex: number, palette: string[], designSystem: DesignSystem) => 1 | -1) => (contrastCondition: (contrastRatio: number) => boolean) => DesignSystemResolver<string>;
/**
