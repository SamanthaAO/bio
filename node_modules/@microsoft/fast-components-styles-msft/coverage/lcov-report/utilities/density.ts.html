...
<html lang="en">
<head>
    <title>Code coverage report for utilities/density.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">utilities</a> density.ts
    </h1>
    <div class='clearfix'>
...
<a name='L178'></a><a href='#L178'>178</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">2x</span>
 ...
 * @param lines The logical number of lines the component takes, typically 1.
 */
export function heightNumber(lines: number = <span class="branch-0 cbranch-no" title="branch not covered" >1)</span>: DesignSystemResolver&lt;number&gt; {
    ...
    return (designSystem: DesignSystem): string =&gt; {
        const value: number =
            typeof adjustment === "function"
                ? <span class="branch-0 cbranch-no" title="branch not covered" >horizontalSpacingNumber(adjustment(designSystem))(designSystem)</span>
...
export function horizontalSpacingNumber(
    adjustment: number = <span class="branch-0 cbranch-no" title="branch not covered" >0</span>
 ...
 * @param unit
 */
export function <span class="fstat-no" title="function not covered" >density(</span>value: number, unit?: string): (config: DesignSystem) =&gt; string {
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >(c</span>onfig: DesignSystem): string =&gt; {</span>
        const augmented: number = <span class="cstat-no" title="statement not covered" >value * 1;</span>
<span class="cstat-no" title="statement not covered" >        return typeof unit === "string" ? `${augmented}${unit}` : toPx(augmented);</span>
    };
}
&nbsp;</pre></td></tr>
</table></pre>
