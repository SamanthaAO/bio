...
<html lang="en">
<head>
    <title>Code coverage report for common.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> common.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { DesignSystem, DesignSystemResolver } from "../../design-system";
...
&nbsp;
export function <span class="fstat-no" title="function not covered" >colorRecipeFactory&lt;</span>T&gt;(recipe: DesignSystemResolver&lt;T&gt;): ColorRecipe&lt;T&gt; {
    const memoizedRecipe: typeof recipe = <span class="cstat-no" title="statement not covered" >memoize(recipe);</span>
&nbsp;
    ...
    function <span class="fstat-no" title="function not covered" >curryRecipe(</span>arg: any): any {
<span class="cstat-no" title="statement not covered" >        if (typeof arg === "function") {</span>
<span class="cstat-no" title="statement not covered" >            return <span class="fstat-no" title="function not covered" >(d</span>esignSystem: DesignSystem): T =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                return memoizedRecipe(</span>
...
<span class="cstat-no" title="statement not covered" >            return memoizedRecipe(arg);</span>
        }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return curryRecipe;</span>
}
&nbsp;
/**
 ...
 * use in stylesheets.
 */
export function <span class="fstat-no" title="function not covered" >swatchFamilyToSwatchRecipeFactory&lt;</span>T extends SwatchFamily&gt;(
    type: keyof T,
    callback: SwatchFamilyResolver&lt;T&gt;
): SwatchRecipe {
    const memoizedRecipe: typeof callback = <span class="cstat-no" title="statement not covered" >memoize(callback);</span>
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >(a</span>rg: DesignSystem | SwatchResolver): any =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        if (typeof arg === "function") {</span>
<span class="cstat-no" title="statement not covered" >            return <span class="fstat-no" title="function not covered" >(d</span>esignSystem: DesignSystem): Swatch =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                return memoizedRecipe(</span>
                    Object.assign({}, designSystem, {
                        backgroundColor: arg(designSystem),
                    })
...
<span class="cstat-no" title="statement not covered" >            return memoizedRecipe(arg)[type];</span>
        }
    };
}
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (color !== null) {
        return parsed;
    } 
&nbsp;
<span class="cstat-no" title="statement not covered" >    parsed = parseColorWebRGB(color);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    console.log('=======\n', parsed,"\n=======")</span>
<span class="cstat-no" title="statement not covered" >    if (parsed !== null) {</span>
 ...
 * Supports #RRGGBB and rgb(r, g, b) formats
 */
export function <span class="fstat-no" title="function not covered" >luminance(</span>color: any): number {
<span class="cstat-no" title="statement not covered" >    return rgbToRelativeLuminance(parseColorString(color));</span>
}
&nbsp;
export function <span class="fstat-no" title="function not covered" >designSystemResolverMax(</span>
    ...args: Array&lt;DesignSystemResolver&lt;number&gt;&gt;
): DesignSystemResolver&lt;number&gt; {
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >(d</span>esignSystem: DesignSystem): number =&gt;</span>
<span class="cstat-no" title="statement not covered" >        Math.max.apply(</span>
            null,
            args.map(<span class="fstat-no" title="function not covered" >(f</span>n: DesignSystemResolver&lt;number&gt;) =&gt; <span class="cstat-no" title="statement not covered" >fn(designSystem))</span>
        );
}
&nbsp;</pre></td></tr>
</table></pre>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Tue Oct 15 2019 10:16:48 GMT-0700 (Pacific Daylight Time)
</div>
</div>
