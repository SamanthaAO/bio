...
<html lang="en">
<head>
    <title>Code coverage report for src/utilities/color/neutral-focus.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/utilities/color</a> neutral-focus.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { findClosestSwatchIndex, isDarkMode, Palette, swatchByContrast } from "./palette";
...
function neutralFocusDirectionResolver(
    ...
    return isDarkMode(designSystem) ? <span class="branch-0 cbranch-no" title="branch not covered" >-1 </span>: 1;
}
&nbsp;
...
&nbsp;
function <span class="fstat-no" title="function not covered" >neutralFocusInnerAccentIndexResolver(</span>
...
<span class="cstat-no" title="statement not covered" >        return sourcePalette.indexOf(accentFillColor(designSystem));</span>
    };
}
&nbsp;
function <span class="fstat-no" title="function not covered" >neutralFocusInnerAccentDirectionResolver(</span>
    referenceIndex: number,
    palette: string[],
    designSystem: DesignSystem
): 1 | -1 {
<span class="cstat-no" title="statement not covered" >    return isDarkMode(designSystem) ? 1 : -1;</span>
}
&nbsp;
export function <span class="fstat-no" title="function not covered" >neutralFocusInnerAccent(</span>
    accentFillColor: DesignSystemResolver&lt;string&gt;
): DesignSystemResolver&lt;string&gt; {
<span class="cstat-no" title="statement not covered" >    return swatchByContrast(neutralFocus)(accentPalette)(</span>
