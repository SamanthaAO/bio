...
<html lang="en">
<head>
    <title>Code coverage report for src/utilities/color/neutral-layer.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/utilities/color</a> neutral-layer.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { findClosestSwatchIndex, getSwatch, Palette, swatchByMode } from "./palette";
import {
    ColorRecipe,
    colorRecipeFactory,
 ...
 */
const neutralLayerCardIndex: DesignSystemResolver&lt;number&gt; = <span class="fstat-no" title="function not covered" >(</span>
    designSystem: DesignSystem
): number =&gt;
<span class="cstat-no" title="statement not covered" >    clamp(</span>
