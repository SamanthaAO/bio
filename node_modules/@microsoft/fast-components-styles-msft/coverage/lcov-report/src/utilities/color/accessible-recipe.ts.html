...
<html lang="en">
<head>
    <title>Code coverage report for src/utilities/color/accessible-recipe.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/utilities/color</a> accessible-recipe.ts
    </h1>
    <div class='clearfix'>
...
<a name='L104'></a><a href='#L104'>104</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">2x</span>
...
&nbsp;
    const restIndex: number = indexOneIsRestState ? <span class="branch-0 cbranch-no" title="branch not covered" >accessibleIndex </span>: accessibleIndex2;
    const hoverIndex: number = indexOneIsRestState ? <span class="branch-0 cbranch-no" title="branch not covered" >accessibleIndex2 </span>: accessibleIndex;
&nbsp;
