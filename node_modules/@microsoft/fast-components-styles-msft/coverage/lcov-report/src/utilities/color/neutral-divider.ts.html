...
<html lang="en">
<head>
    <title>Code coverage report for src/utilities/color/neutral-divider.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/utilities/color</a> neutral-divider.ts
    </h1>
    <div class='clearfix'>
...
const neutralDividerAlgorithm: SwatchResolver = (designSystem: DesignSystem): Swatch =&gt; {
    ...
    const direction: 1 | -1 = isDarkMode(designSystem) ? <span class="branch-0 cbranch-no" title="branch not covered" >-1 </span>: 1;
&nbsp;
