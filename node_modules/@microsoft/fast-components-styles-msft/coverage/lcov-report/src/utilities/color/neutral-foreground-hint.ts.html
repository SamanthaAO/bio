...
<html lang="en">
<head>
    <title>Code coverage report for src/utilities/color/neutral-foreground-hint.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/utilities/color</a> neutral-foreground-hint.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { DesignSystemResolver } from "../../design-system";
import {
    colorRecipeFactory,
    SwatchFamily,
