...
<html lang="en">
<head>
    <title>Code coverage report for src/utilities/elevation.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/utilities</a> elevation.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { toPx } from "@microsoft/fast-jss-utilities";
 ...
 */
export function <span class="fstat-no" title="function not covered" >elevation(</span>
    elevationValue: ElevationMultiplier | number,
    color: string = <span class="branch-0 cbranch-no" title="branch not covered" >black</span>
): (config: DesignSystem) =&gt; CSSRules&lt;DesignSystem&gt; {
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >(c</span>onfig: DesignSystem): CSSRules&lt;DesignSystem&gt; =&gt; {</span>
...
export function elevationShadow(
    ...
    return (config: DesignSystem): string =&gt; {
        ...
        const {
            ...
            opacity,
            blurMultiplier,
            blurBase = <span class="branch-0 cbranch-no" title="branch not covered" >0,</span>
        }: ShadowConfig = shadowConfig;
