...
<html lang="en">
<head>
    <title>Code coverage report for src/utilities/density.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/utilities</a> density.ts
    </h1>
    <div class='clearfix'>
...
<a name='L159'></a><a href='#L159'>159</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">2x</span>
...
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >(c</span>onfig: DesignSystem): string =&gt; <span class="cstat-no" title="statement not covered" >toUnit(unit)(value * 1);</span></span>
}
&nbsp;</pre></td></tr>
</table></pre>
