...
<html lang="en">
<head>
    <title>Code coverage report for design-system/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">design-system</a> index.ts
    </h1>
    <div class='clearfix'>
...
<a name='L291'></a><a href='#L291'>291</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">3x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Direction } from "@microsoft/fast-web-utilities";
...
&nbsp;
export function createColorPalette(baseColor: ColorRGBA64): ColorRGBA64[] {
 ...
 */
export function <span class="fstat-no" title="function not covered" >getDesignSystemProperty(</span>key: string): DesignSystemResolver&lt;string&gt; {
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >function(c</span>onfig: DesignSystem): string {</span>
<span class="cstat-no" title="statement not covered" >        return withDesignSystemDefaults(config)[key];</span>
    };
}
&nbsp;
/**
 ...
 */
export function <span class="fstat-no" title="function not covered" >ensureDesignSystemDefaults&lt;</span>T&gt;(
...
<span class="cstat-no" title="statement not covered" >        return callback(withDesignSystemDefaults(designSystem));</span>
    };
}
&nbsp;
/**
