...
<html lang="en">
<head>
    <title>Code coverage report for fast-colors/src/color-palette.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">fast-colors/src</a> color-palette.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">79.53% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>101/127</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
    public <span class="fstat-no" title="function not covered" >updatePaletteGenerationValues(</span>newConfig: ColorPaletteConfig): boolean {
        let changed: boolean = <span class="cstat-no" title="statement not covered" >false;</span>
<span class="cstat-no" title="statement not covered" >        for (const key in newConfig) {</span>
<span class="cstat-no" title="statement not covered" >            if (this.config[key]) {</span>
<span class="cstat-no" title="statement not covered" >                if (this.config[key].equalValue) {</span>
<span class="cstat-no" title="statement not covered" >                    if (!this.config[key].equalValue(newConfig[key])) {</span>
<span class="cstat-no" title="statement not covered" >                        this.config[key] = newConfig[key];</span>
<span class="cstat-no" title="statement not covered" >                        changed = true;</span>
                    }
                } else {
<span class="cstat-no" title="statement not covered" >                    if (newConfig[key] !== this.config[key]) {</span>
<span class="cstat-no" title="statement not covered" >                        this.config[key] = newConfig[key];</span>
<span class="cstat-no" title="statement not covered" >                        changed = true;</span>
                    }
                }
...
<span class="cstat-no" title="statement not covered" >            this.updatePaletteColors();</span>
        }
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.config.multiplyLight !== 0) {
            const multiply: ColorRGBA64 = <span class="cstat-no" title="statement not covered" >blendMultiply(</span>
                this.config.baseColor,
                adjustedLight
            );
<span class="cstat-no" title="statement not covered" >            adjustedLight = interpolateByColorSpace(</span>
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.config.multiplyDark !== 0) {
            const multiply: ColorRGBA64 = <span class="cstat-no" title="statement not covered" >blendMultiply(</span>
                this.config.baseColor,
                adjustedDark
            );
<span class="cstat-no" title="statement not covered" >            adjustedDark = interpolateByColorSpace(</span>
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.config.overlayLight !== 0) {
            const overlay: ColorRGBA64 = <span class="cstat-no" title="statement not covered" >blendOverlay(</span>
                this.config.baseColor,
                adjustedLight
            );
<span class="cstat-no" title="statement not covered" >            adjustedLight = interpolateByColorSpace(</span>
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.config.baseScalePosition) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.config.baseScalePosition &lt;= 0) {
<span class="cstat-no" title="statement not covered" >                return new ColorScale([</span>
            ...
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.config.baseScalePosition &gt;= 1) {
<span class="cstat-no" title="statement not covered" >                return new ColorScale([</span>
...
export function rescale(
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (input.length &lt;= 1 || targetSize &lt;= 1) {
<span class="cstat-no" title="statement not covered" >        throw new Error("The input array and targetSize must both be greater than 1");</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (preserveInputColors &amp;&amp; targetSize &lt;= input.length) {
...
export function centeredRescale(
    input: ColorRGBA64[],
    config: CenteredRescaleConfig = <span class="branch-0 cbranch-no" title="branch not covered" >defaultCenteredRescaleConfig</span>
): ColorRGBA64[] {
...
<span class="cstat-no" title="statement not covered" >        return [];</span>
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (offset &lt; 0) {
<span class="cstat-no" title="statement not covered" >        throw new Error(</span>
