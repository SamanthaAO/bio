...
<html lang="en">
<head>
    <title>Code coverage report for fast-colors/src/palette-extractor.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">fast-colors/src</a> palette-extractor.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// tslint:disable:prefer-for-of
&nbsp;
...
export function extractPalette(
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (config.constraints.length === 0) {
