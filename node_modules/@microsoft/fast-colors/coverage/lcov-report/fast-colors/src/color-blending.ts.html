...
<html lang="en">
<head>
    <title>Code coverage report for fast-colors/src/color-blending.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">fast-colors/src</a> color-blending.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2368x</span>
<span class="cline-any cline-yes">2368x</span>
<span class="cline-any cline-yes">2368x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5184x</span>
<span class="cline-any cline-yes">5184x</span>
<span class="cline-any cline-yes">1971x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4x</span>
<span class="cline-any cline-yes">7365x</span>
<span class="cline-any cline-yes">3168x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4197x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4x</span>
<span class="cline-any cline-yes">2455x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
// The alpha channel of the input is ignored
export function <span class="fstat-no" title="function not covered" >blendColor(</span>bottom: ColorRGBA64, top: ColorRGBA64): ColorRGBA64 {
    const bottomHSL: ColorHSL = <span class="cstat-no" title="statement not covered" >rgbToHSL(bottom);</span>
    const topHSL: ColorHSL = <span class="cstat-no" title="statement not covered" >rgbToHSL(top);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (topHSL.s === 0) {</span>
<span class="cstat-no" title="statement not covered" >        return new ColorRGBA64(bottomHSL.l, bottomHSL.l, bottomHSL.l, 1);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return hslToRGB(new ColorHSL(topHSL.h, topHSL.s, bottomHSL.l));</span>
}
&nbsp;
...
&nbsp;
// The alpha channel of the input is ignored
export function <span class="fstat-no" title="function not covered" >blend(</span>
    mode: ColorBlendMode,
    bottom: ColorRGBA64,
    top: ColorRGBA64
): ColorRGBA64 {
...
<span class="cstat-no" title="statement not covered" >            return blendBurn(bottom, top);</span>
        case ColorBlendMode.Color:
<span class="cstat-no" title="statement not covered" >            return blendColor(bottom, top);</span>
        case ColorBlendMode.Darken:
<span class="cstat-no" title="statement not covered" >            return blendDarken(bottom, top);</span>
        case ColorBlendMode.Dodge:
<span class="cstat-no" title="statement not covered" >            return blendDodge(bottom, top);</span>
        case ColorBlendMode.Lighten:
<span class="cstat-no" title="statement not covered" >            return blendLighten(bottom, top);</span>
        case ColorBlendMode.Multiply:
<span class="cstat-no" title="statement not covered" >            return blendMultiply(bottom, top);</span>
        case ColorBlendMode.Overlay:
<span class="cstat-no" title="statement not covered" >            return blendOverlay(bottom, top);</span>
        case ColorBlendMode.Screen:
<span class="cstat-no" title="statement not covered" >            return blendScreen(bottom, top);</span>
        default:
<span class="cstat-no" title="statement not covered" >            throw new Error("Unknown blend mode");</span>
    }
}
&nbsp;
...
export function computeAlphaBlend(bottom: ColorRGBA64, top: ColorRGBA64): ColorRGBA64 {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (top.a &gt;= 1) {
<span class="cstat-no" title="statement not covered" >        return top;</span>
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (top.a &lt;= 0) {
<span class="cstat-no" title="statement not covered" >        return new ColorRGBA64(bottom.r, bottom.g, bottom.b, 1);</span>
    }
&nbsp;
