...
<html lang="en">
<head>
    <title>Code coverage report for fast-colors/src/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">fast-colors/src</a> index.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">3x</span>
<span class="cline-any cline-yes">3x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">export * from "./color-blending";
