...
import { ManagedClasses, SliderTrackItemClassNameContract } from "@microsoft/fast-components-class-name-contracts-base";
export interface SliderTrackItemManagedClasses extends ManagedClasses<SliderTrackItemClassNameContract> {
}
export interface SliderTrackItemUnhandledProps extends React.HTMLAttributes<HTMLDivElement> {
}
export declare enum SliderTrackItemAnchor {
...
export declare type SliderTrackItemProps = SliderTrackItemHandledProps & SliderTrackItemUnhandledProps;
