...
import { ManagedClasses, SliderClassNameContract } from "@microsoft/fast-components-class-name-contracts-base";
...
export interface SliderHandledProps extends SliderManagedClasses {
     ...
     */
    thumb?: (props: SliderProps, state: SliderState, mouseDownCallback: (event: React.MouseEvent) => void, keyDownCallback: (event: React.KeyboardEvent) => void, thumb: SliderThumb, touchStartCallback?: (event: React.TouchEvent) => void) => React.ReactNode;
    /**
     ...
     */
    valuetextStringFormatter?: (sliderProps: SliderHandledProps, sliderState: SliderState, thumb: SliderThumb) => string;
    /**
...
export declare type SliderProps = SliderUnhandledProps & SliderHandledProps;
