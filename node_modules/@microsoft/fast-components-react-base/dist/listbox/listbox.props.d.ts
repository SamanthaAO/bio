...
import { ListboxClassNameContract, ManagedClasses } from "@microsoft/fast-components-class-name-contracts-base";
...
export declare type ListboxProps = ListboxHandledProps & ListboxUnhandledProps;
