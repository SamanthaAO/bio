...
export declare enum LabelTag {
    label = "label",
    legend = "legend"
}
export interface LabelManagedClasses extends ManagedClasses<LabelClassNameContract> {
}
export interface LabelUnhandledProps extends React.LabelHTMLAttributes<HTMLLabelElement | HTMLLegendElement>, React.HTMLAttributes<HTMLLabelElement | HTMLLegendElement> {
}
...
export declare type LabelProps = LabelHandledProps & LabelUnhandledProps;
