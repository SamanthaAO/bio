...
import { BreadcrumbClassNameContract, ManagedClasses } from "@microsoft/fast-components-class-name-contracts-base";
export interface BreadcrumbManagedClasses extends ManagedClasses<BreadcrumbClassNameContract> {
}
...
export declare type BreadcrumbProps = BreadcrumbHandledProps & BreadcrumbUnhandledProps;
