...
export interface TreeViewItemUnhandledProps extends React.HTMLAttributes<HTMLDivElement> {
}
export interface TreeViewItemHandledProps extends TreeViewItemManagedClasses {
     ...
     */
    onSelected?: (props: TreeViewItemProps, e?: React.MouseEvent<HTMLDivElement> | React.KeyboardEvent<HTMLDivElement>) => void;
    /**
