...
export interface TreeViewManagedClasses extends ManagedClasses<TreeViewClassNameContract> {
}
...
export declare type TreeViewProps = TreeViewHandledProps & TreeViewUnhandledProps;
