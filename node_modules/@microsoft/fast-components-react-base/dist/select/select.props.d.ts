...
import { ManagedClasses, SelectClassNameContract } from "@microsoft/fast-components-class-name-contracts-base";
...
export interface SelectHandledProps extends SelectManagedClasses {
     ...
     */
    trigger?: (props: SelectProps, state: SelectState, triggerId?: string) => React.ReactNode;
    /**
     * Custom function to render the menu of the control
     */
    menu?: (props: SelectProps, state: SelectState, defaultMenu: React.ReactNode) => React.ReactNode;
    /**
     * Function which converts and formats the string may be displayed in the ui
     * in the UI
     */
    displayStringFormatter?: (selectedOptions: ListboxItemProps[], placeholder: string) => string;
    /**
     ...
     */
    onValueChange?: (newValue: string | string[], selectedItems: ListboxItemProps[], displayString: string) => void;
    /**
...
export declare type SelectProps = SelectHandledProps & SelectUnhandledProps;
