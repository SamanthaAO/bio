...
import { ManagedClasses, ViewportPositionerClassNameContract } from "@microsoft/fast-components-class-name-contracts-base";
export interface ViewportPositionerManagedClasses extends ManagedClasses<ViewportPositionerClassNameContract> {
}
export interface ViewportPositionerUnhandledProps extends React.HTMLAttributes<HTMLDivElement> {
}
export declare enum ViewportPositionerHorizontalPosition {
    left = "left",
    right = "right",
    uncontrolled = "uncontrolled"
}
export declare enum ViewportPositionerVerticalPosition {
    top = "top",
    bottom = "bottom",
    uncontrolled = "uncontrolled"
}
export declare enum AxisPositioningMode {
    uncontrolled = "uncontrolled",
    adjacent = "adjacent",
    inset = "inset"
}
...
export declare type ViewportPositionerProps = ViewportPositionerHandledProps & ViewportPositionerUnhandledProps;
