...
import { AutoSuggestClassNameContract, ManagedClasses } from "@microsoft/fast-components-class-name-contracts-base";
...
export interface AutoSuggestHandledProps extends AutoSuggestManagedClasses {
     ...
     */
    inputRegion?: (props: AutoSuggestProps, state: AutoSuggestState, changeCallback: (event: React.ChangeEvent) => void, buttonClickCallback: (event: React.MouseEvent) => void, keyDownCallback: (event: React.KeyboardEvent) => void, focusCallback?: (event: React.FocusEvent) => void) => React.ReactNode;
    /**
