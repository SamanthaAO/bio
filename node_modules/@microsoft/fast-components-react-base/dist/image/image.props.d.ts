...
export interface ImageHandledProps extends ImageManagedClasses {
     ...
     * The image children
     */
    children?: Array<React.ReactElement<HTMLSourceElement>> | React.ReactElement<HTMLSourceElement>;
}
export declare type ImageProps = ImageHandledProps & ImageUnhandledProps;
