...
export interface ContextMenuItemUnhandledProps extends Omit<React.HTMLAttributes<HTMLDivElement>, "role"> {
}
export interface ContextMenuItemHandledProps extends ContextMenuItemManagedClasses {
     ...
     */
    onInvoke?: (e: React.MouseEvent<HTMLDivElement> | React.KeyboardEvent<HTMLDivElement>, props: ContextMenuItemProps) => void;
}
export declare type ContextMenuItemProps = ContextMenuItemHandledProps & ContextMenuItemUnhandledProps;
