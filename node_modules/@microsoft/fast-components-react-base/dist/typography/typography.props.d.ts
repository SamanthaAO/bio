...
export declare enum TypographyTag {
    caption = "caption",
    h1 = "h1",
    h2 = "h2",
    h3 = "h3",
...
export interface TypographyUnhandledProps extends React.HTMLAttributes<HTMLHeadingElement | HTMLParagraphElement | HTMLSpanElement | HTMLTableCaptionElement> {
}
...
export declare type TypographyProps = TypographyHandledProps & TypographyUnhandledProps;
