...
export interface HypertextUnhandledProps extends React.AnchorHTMLAttributes<HTMLAnchorElement> {
}
...
export declare type HypertextProps = HypertextHandledProps & HypertextUnhandledProps;
