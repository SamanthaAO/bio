 ...
 */
export declare type CSSStaticRule = CSS.Properties | string;
/**
 ...
 */
export declare type CSSRuleResolver<T> = (config?: T) => string;
/**
 ...
 * property functions that resolve to a CSS value.
 */
export declare type ComponentStyles<T, C> = ComponentStyleSheet<T, C> | ComponentStyleSheetResolver<T, C>;
/**
 ...
 * property functions that resolve to a CSS value.
 */
export declare type ComponentStyleSheetResolver<T, C> = (config: C) => ComponentStyleSheet<T, C>;
/**
 ...
 * property functions that resolve to a CSS value.
 */
export declare type ComponentClassNameStyleSheet<T, C> = {
    [P in keyof T]: CSSRules<C>;
};
export declare type ComponentStyleSheet<T, C> = ComponentClassNameStyleSheet<T, C> & NestedAtRules<C>;
export declare type DesignSystemMergingFunction<T> = (original: T, overrides: T) => T;
/**
 ...
 */
export declare function mergeDesignSystem<T>(original: T, overrides: T): T;
