  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>106/142</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">export interface AnimateConfig {
    /**
...
&nbsp;
<span class="fstat-no" title="function not covered" >    public get o</span>nFinish(): () =&gt; void {
<span class="cstat-no" title="statement not covered" >        return this._onFinish;</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    public set onFinish(c</span>allback: () =&gt; void) {
<span class="cstat-no" title="statement not covered" >        this._onFinish = callback;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (Boolean(this.animation)) {</span>
<span class="cstat-no" title="statement not covered" >            this.animation.onfinish = callback;</span>
        }
    }
&nbsp;
    constructor(
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (Boolean(effectTiming)) {
<span class="cstat-no" title="statement not covered" >            this.effectTiming = Object.assign({}, this.effectTiming, effectTiming);</span>
        }
&nbsp;
        if (options) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (options.transformOrigin) {
<span class="cstat-no" title="statement not covered" >                element.style.transformOrigin = options.transformOrigin;</span>
            }
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (options.transformStyle) {
<span class="cstat-no" title="statement not covered" >                element.style.transformStyle = options.transformStyle;</span>
            }
        }
&nbsp;
...
&nbsp;
     ...
     * plays the animation
     */
    public play = <span class="fstat-no" title="function not covered" >(): void =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        this.ensureAnimationObjectExists();</span>
<span class="cstat-no" title="statement not covered" >        this.animation.play();</span>
    };
&nbsp;
    /**
     * pauses the animation
     */
    public pause = <span class="fstat-no" title="function not covered" >(): void =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        this.ensureAnimationObjectExists();</span>
<span class="cstat-no" title="statement not covered" >        this.animation.pause();</span>
    };
&nbsp;
    /**
     * finishes the animation
     */
    public finish = <span class="fstat-no" title="function not covered" >(): void =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        this.ensureAnimationObjectExists();</span>
<span class="cstat-no" title="statement not covered" >        this.animation.finish();</span>
    };
&nbsp;
    /**
     * cancels the animation
     */
    public cancel = <span class="fstat-no" title="function not covered" >(): void =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        this.ensureAnimationObjectExists();</span>
<span class="cstat-no" title="statement not covered" >        this.animation.cancel();</span>
    };
&nbsp;
    /**
     * reverses an animation
     */
    public reverse = <span class="fstat-no" title="function not covered" >(): void =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        this.ensureAnimationObjectExists();</span>
<span class="cstat-no" title="statement not covered" >        this.animation.reverse();</span>
    };
&nbsp;
    /**
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    private e</span>nsureAnimationObjectExists(): void {
<span class="cstat-no" title="statement not covered" >        if (typeof this.animation === "undefined") {</span>
<span class="cstat-no" title="statement not covered" >            this.createAnimationObject();</span>
        }
    }
    /**
     * Creates the animation object
     */
<span class="fstat-no" title="function not covered" >    private c</span>reateAnimationObject(): void {
<span class="cstat-no" title="statement not covered" >        this.animation = new Animation(this.keyframeEffect, document.timeline);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (typeof this.onFinish !== "undefined") {</span>
<span class="cstat-no" title="statement not covered" >            this.animation.onfinish = this.onFinish;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (typeof this.onCancel !== "undefined") {</span>
<span class="cstat-no" title="statement not covered" >            this.animation.oncancel = this.onCancel;</span>
        }
    }
&nbsp;
    /**
...
&nbsp;
                <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(matrixValues)) {
                    const normalizedValues: string[] = <span class="cstat-no" title="statement not covered" >matrixValues[1]</span>
                        .split(",")
                        .map(<span class="fstat-no" title="function not covered" >(m</span>atchedValue: string, index: number) =&gt; {
                            const parsedValueIsZero: boolean = <span class="cstat-no" title="statement not covered" >parseFloat(value) === 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                            if (!parsedValueIsZero) {</span>
<span class="cstat-no" title="statement not covered" >                                return matchedValue;</span>
                            }
&nbsp;
                            // If this is the scaleX index or the scaleY index, return the coerced value
<span class="cstat-no" title="statement not covered" >                            return index === 0 || index === 3</span>
                                ? coercedReturn
                                : matchedValue;
                        });
&nbsp;
<span class="cstat-no" title="statement not covered" >                    return `matrix(${normalizedValues.join(",")})`;</span>
                }
&nbsp;
                break;
            case "opacity":
                return parseFloat(value) === 0 ? <span class="branch-0 cbranch-no" title="branch not covered" >coercedReturn </span>: value;
        }
&nbsp;
        return value;
    }
...
<span class="cstat-no" title="statement not covered" >            return {} as Keyframe;</span>
        }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                    value = 0.01;</span>
                }
        }
&nbsp;
...
<span class="branch-1 cbranch-no" title="branch not covered" >                            case "top":</span>
<span class="branch-2 cbranch-no" title="branch not covered" >                            case "right":</span>
<span class="branch-3 cbranch-no" title="branch not covered" >                            case "bottom":</span>
<span class="branch-4 cbranch-no" title="branch not covered" >                            case "left":</span>
...
&nbsp;
        return this.mode === AnimationMode.animateFrom ? <span class="branch-0 cbranch-no" title="branch not covered" >keyframes.reverse() </span>: keyframes;
    }
&nbsp;
    /**
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    public get k</span>eyframeEffect(): KeyframeEffect {
<span class="cstat-no" title="statement not covered" >        return new KeyframeEffect(</span>
            this.animationTarget,
            this.keyframes,
            this.effectTiming
        );
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Wed Dec 18 2019 10:43:21 GMT-0800 (Pacific Standard Time)
</div>
</div>
