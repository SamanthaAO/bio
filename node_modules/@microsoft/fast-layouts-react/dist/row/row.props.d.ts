 ...
 */
export declare enum RowResizeDirection {
    north = "north",
    south = "south"
}
...
export interface RowHandledProps extends RowManagedClasses {
     ...
     */
    onResize?: (e: MouseEvent | React.KeyboardEvent<HTMLButtonElement>, height?: number) => void;
    /**
     * The optional custom resize handler
     */
    resizeControl?: (props: RowResizeControlProps) => React.ReactNode;
}
export declare type RowProps = RowHandledProps & RowUnhandledProps;
