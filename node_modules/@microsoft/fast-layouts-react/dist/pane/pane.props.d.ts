 ...
 */
export declare enum PaneResizeDirection {
    east = "east",
    west = "west"
}
...
export interface PaneHandledProps extends PaneManagedClasses {
     ...
     */
    onResize?: (e: MouseEvent | React.KeyboardEvent<HTMLButtonElement>, width?: number) => void;
    /**
     * The optional custom resize handler
     */
    resizeControl?: (props: PaneResizeControlProps) => React.ReactNode;
}
export declare type PaneProps = PaneHandledProps & PaneUnhandledProps;
