...
class AutoSuggest extends Foundation {
    constructor() {
        ...
        this.defaultInputRegionRenderFunction = (props, state, onChange, onClick, onKeyDown) => {
            ...
            return (React.createElement(TextAction, { disabled: props.disabled, onChange: onChange, onClick: onClick, onKeyDown: onKeyDown, value: state.value, placeholder: props.placeholder, beforeGlyph: this.generateGlyph, role: "combobox", "aria-label": props.label || null, "aria-autocomplete": "both", "aria-activedescendant": activedescendantId || null, "aria-owns": listboxId || null, "aria-controls": listboxId || null }));
        };
        /**
