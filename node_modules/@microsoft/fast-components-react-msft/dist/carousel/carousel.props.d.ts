...
import { CarouselClassNameContract, ManagedClasses } from "@microsoft/fast-components-class-name-contracts-msft";
/**
 * The carousel slide theme
 */
export declare enum CarouselSlideTheme {
    light = "light",
    dark = "dark"
}
/**
 ...
 */
export interface CarouselManagedClasses extends ManagedClasses<CarouselClassNameContract> {
}
/**
...
export interface CarouselHandledProps extends CarouselManagedClasses {
     ...
     */
    nextFlipper?: (onClick: (e?: React.MouseEvent<HTMLElement>) => void, className?: string) => React.ReactNode;
    /**
     * The carousel previous flipper
     */
    previousFlipper?: (onClick: (e?: React.MouseEvent<HTMLElement>) => void, className?: string) => React.ReactNode;
}
export interface CarouselUnhandledProps extends React.HTMLAttributes<HTMLDivElement> {
}
export declare type CarouselProps = CarouselHandledProps & CarouselUnhandledProps;
