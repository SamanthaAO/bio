...
import { TextFieldHandledProps, TextFieldManagedClasses } from "@microsoft/fast-components-react-base";
import { Omit, Subtract } from "utility-types";
export declare enum TextActionAppearance {
    filled = "filled",
    outline = "outline"
}
export declare enum TextActionButtonPosition {
    before = "before",
    after = "after"
}
export interface TextActionManagedClasses extends ManagedClasses<TextActionClassNameContract> {
}
export interface TextActionUnhandledProps extends Omit<React.InputHTMLAttributes<HTMLInputElement>, "type"> {
}
export interface TextActionHandledProps extends Subtract<TextFieldHandledProps, TextFieldManagedClasses>, TextActionManagedClasses {
    /**
...
export declare type TextActionProps = TextActionHandledProps & TextActionUnhandledProps;
