...
export declare enum HeadingAlignBaseline {
    small = "small",
    large = "large"
}
...
export interface HeadingUnhandledProps extends React.HTMLAttributes<HTMLHeadingElement | HTMLParagraphElement> {
}
export declare type HeadingProps = HeadingHandledProps & HeadingUnhandledProps;
