...
import { AxisPositioningMode, ViewportPositionerHandledProps, ViewportPositionerHorizontalPosition, ViewportPositionerManagedClasses, ViewportPositionerUnhandledProps, ViewportPositionerVerticalPosition } from "@microsoft/fast-components-react-base";
import { FlyoutClassNameContract, ManagedClasses } from "@microsoft/fast-components-class-name-contracts-msft";
import { Subtract } from "utility-types";
export declare enum FlyoutHorizontalPosition {
    left = "left",
    right = "right",
    uncontrolled = "uncontrolled"
}
export declare enum FlyoutVerticalPosition {
    top = "top",
    bottom = "bottom",
    uncontrolled = "uncontrolled"
}
export declare enum FlyoutAxisPositioningMode {
    uncontrolled = "uncontrolled",
    adjacent = "adjacent",
    inset = "inset"
}
...
export interface FlyoutHandledProps extends Subtract<ViewportPositionerHandledProps, ViewportPositionerSubtractedProps>, FlyoutManagedClasses {
    /**
...
export declare type FlyoutProps = FlyoutHandledProps & FlyoutUnhandledProps;
export {};
