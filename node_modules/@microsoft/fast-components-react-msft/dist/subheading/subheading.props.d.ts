...
export declare enum SubheadingSize {
    _1 = 1,
    _2 = 2,
    _3 = 3,
    _4 = 4,
...
export declare enum SubheadingTag {
    h1 = "h1",
    h2 = "h2",
    h3 = "h3",
    h4 = "h4",
...
export declare type SubheadingProps = SubheadingHandledProps & SubheadingUnhandledProps;
